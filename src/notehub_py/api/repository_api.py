...
class RepositoryApi:
    ...
    def create_repository_dataset(
        ...
        x_repository_key: Annotated[StrictStr, Field(description="The secret key used to access this repository")],
        data_set: DataSet,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_repository_data(
        ...
        x_repository_key: Annotated[StrictStr, Field(description="The secret key used to access this repository")],
        repository_uid: StrictStr,
        start: Annotated[StrictStr, Field(description="Start of the time range, as an ISO-8601 date or relative to now (e.g. -1y). Relative dates follow the Postgres INTERVAL format.")],
        end: Annotated[Optional[StrictStr], Field(description="End of the time range, as an ISO-8601 date or relative to now. If omitted, current time is used.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def query_repository_dataset(
        ...
        select: Annotated[Optional[StrictStr], Field(description="Comma separated list of fields to include. Supports aggregate functions (avg, sum, min, max, count, most_recent).")] = None,
        where: Annotated[Optional[StrictStr], Field(description="Additional filters using boolean logic mini-language (e.g. and.(device.eq.dev:123,temp.gt.100))")] = None,
        aggregate_window: Annotated[Optional[StrictStr], Field(description="Aggregate results into buckets for a time duration, expressed in Postgres INTERVAL format")] = None,
        location_near: Annotated[Optional[StrictStr], Field(description="Latitude and Longitude for location-based filtering, location_near_radius must also be provided")] = None,
        location_near_radius: Annotated[Optional[StrictInt], Field(description="Distance from location_near in meters, location_near must also be provided")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Limit the number of results returned")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Order the results by a field")] = None,
        distinct: Annotated[Optional[StrictBool], Field(description="Return only distinct results")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def query_repository_sql(
        ...
        repository_uid: StrictStr,
        x_repository_key: Annotated[StrictStr, Field(description="The secret key used to access this repository")],
        body: Annotated[StrictStr, Field(description="Clickhouse-compatible SQL statement")],
        x_click_house_format: Annotated[Optional[StrictStr], Field(description="Specify the format of the response data. This functions the same as the ClickHouse `FORMAT` clause. Supported values include `CSV`, `JSON`, `JSONEachRow`, `TabSeparated`, and `NDJSON`. If not specified, defaults to `TabSeparated`.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
