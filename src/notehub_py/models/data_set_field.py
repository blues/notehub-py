...
class DataSetField(BaseModel):
    ...
    datatype: Optional[StrictInt] = Field(default=None, description="The datatype of the field")
    jsonata: Optional[StrictStr] = Field(default=None, description="the JSONata expression used to populate this field")
