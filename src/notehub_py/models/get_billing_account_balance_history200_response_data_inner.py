...
class GetBillingAccountBalanceHistory200ResponseDataInner(BaseModel):
    """
    GetBillingAccountBalanceHistory200ResponseDataInner
    """  # noqa: E501

    period: datetime
    remaining_event_capacity: StrictInt
    total_event_capacity_used: StrictInt
        ...
        _obj = cls.model_validate(
            {
                ...
                "remaining_event_capacity": obj.get("remaining_event_capacity"),
                "total_event_capacity_used": obj.get("total_event_capacity_used"),
            }
        )
        return _obj
