...
get_device_sessions200_response_dict = (
    get_device_sessions200_response_instance.to_dict()
)
# create an instance of GetDeviceSessions200Response from a dict
get_device_sessions200_response_from_dict = GetDeviceSessions200Response.from_dict(
    get_device_sessions200_response_dict
)
```
