...
get_device_public_key200_response_instance = GetDevicePublicKey200Response.from_json(
    json
)
...
get_device_public_key200_response_dict = (
    get_device_public_key200_response_instance.to_dict()
)
# create an instance of GetDevicePublicKey200Response from a dict
get_device_public_key200_response_from_dict = GetDevicePublicKey200Response.from_dict(
    get_device_public_key200_response_dict
)
```
