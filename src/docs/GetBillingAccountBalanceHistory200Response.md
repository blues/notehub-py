...
get_billing_account_balance_history200_response_instance = (
    GetBillingAccountBalanceHistory200Response.from_json(json)
)
# print the JSON string representation of the object
print(GetBillingAccountBalanceHistory200Response.to_json())

# convert the object into a dict
get_billing_account_balance_history200_response_dict = (
    get_billing_account_balance_history200_response_instance.to_dict()
)
# create an instance of GetBillingAccountBalanceHistory200Response from a dict
get_billing_account_balance_history200_response_from_dict = (
    GetBillingAccountBalanceHistory200Response.from_dict(
        get_billing_account_balance_history200_response_dict
    )
)
```
