...
get_device_latest_events200_response_instance = (
    GetDeviceLatestEvents200Response.from_json(json)
)
# print the JSON string representation of the object
print(GetDeviceLatestEvents200Response.to_json())

# convert the object into a dict
get_device_latest_events200_response_dict = (
    get_device_latest_events200_response_instance.to_dict()
)
# create an instance of GetDeviceLatestEvents200Response from a dict
get_device_latest_events200_response_from_dict = (
    GetDeviceLatestEvents200Response.from_dict(
        get_device_latest_events200_response_dict
    )
)
```
