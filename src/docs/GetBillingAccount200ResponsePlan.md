...
get_billing_account200_response_plan_instance = (
    GetBillingAccount200ResponsePlan.from_json(json)
)
# print the JSON string representation of the object
print(GetBillingAccount200ResponsePlan.to_json())

# convert the object into a dict
get_billing_account200_response_plan_dict = (
    get_billing_account200_response_plan_instance.to_dict()
)
# create an instance of GetBillingAccount200ResponsePlan from a dict
get_billing_account200_response_plan_from_dict = (
    GetBillingAccount200ResponsePlan.from_dict(
        get_billing_account200_response_plan_dict
    )
)
```
