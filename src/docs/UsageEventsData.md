...
| **total_fw_updates**     | **int**            | Number of firmware updates in this period (from \_health.qo DFU events)                                                                                                                                                                                              | [optional] |
| **total_reboots**        | **int**            | Number of device reboots in this period (from \_health.qo boot events)                                                                                                                                                                                               | [optional] |
