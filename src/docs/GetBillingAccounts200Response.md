...
get_billing_accounts200_response_instance = GetBillingAccounts200Response.from_json(
    json
)
...
get_billing_accounts200_response_dict = (
    get_billing_accounts200_response_instance.to_dict()
)
# create an instance of GetBillingAccounts200Response from a dict
get_billing_accounts200_response_from_dict = GetBillingAccounts200Response.from_dict(
    get_billing_accounts200_response_dict
)
```
