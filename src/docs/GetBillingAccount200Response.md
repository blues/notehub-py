...
get_billing_account200_response_dict = get_billing_account200_response_instance.to_dict()
# create an instance of GetBillingAccount200Response from a dict
get_billing_account200_response_from_dict = GetBillingAccount200Response.from_dict(get_billing_account200_response_dict)
```
