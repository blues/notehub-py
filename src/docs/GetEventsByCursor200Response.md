...
get_events_by_cursor200_response_dict = (
    get_events_by_cursor200_response_instance.to_dict()
)
# create an instance of GetEventsByCursor200Response from a dict
get_events_by_cursor200_response_from_dict = GetEventsByCursor200Response.from_dict(
    get_events_by_cursor200_response_dict
)
```
